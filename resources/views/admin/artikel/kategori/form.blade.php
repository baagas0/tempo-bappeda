...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <div class="card">
            <form method="POST" action="{{ (empty($data) ? route('category.store') : route('category.update', $data->id)) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <label for="parent_id" class="control-label col-form-label">Kategori</label>
                                <input type="text" class="form-control" value="{{ (empty($data) ? old('kategori') : $data->kategori) }}" name="kategori">
                            </div>
                        </div>
                    </div>
                </div>
