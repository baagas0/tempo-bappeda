...
@section('breadcumb', 'Berita Management')
@section('rihgt-head')
{{-- <a href="#" onclick="sync()"><button type="button" id="sync" class="float-right ml-3 btn btn-sm btn-danger"><i class="mdi mdi-sync"></i> Sync </button></a> --}}

<a href="{{ route('berita.add') }}"><button type="button" id="sync" class="float-right btn btn-sm btn-primary"><i class=" mdi mdi-library-plus
    ...
    <table id="BasicTable" class="table display">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{!! Str::limit($data->caption, 35) !!}</td>
                <td>{{$data->type}}</td>
                <td hidden>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu animated flipInY">
                            <a class="dropdown-item" href="{{ route('berita.edit',$data->id) }}">Edit</a>
                            <a class="dropdown-item" href="{{ route('berita.destroy',$data->id) }}">Hapus</a>
                        </div>
                    </div>
                </td>
            </tr>
