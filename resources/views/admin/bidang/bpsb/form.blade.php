...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <div class="card">
            <form method="POST" action="{{ (empty($data) ? route('bidang-manage.store') : route('bidang-manage.update', $data->id)) }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="custom-file">
                                <?php use App\Models\Bidang as BidangModels;
                                    $bidang = BidangModels::get();
                                ?>
                                <select class="form-control" name="bidang_id">
                                    <option>Pilih Data Bidang</option>
                                    @foreach($bidang as $row)
                                    @foreach($b as $c)

                        <option value="{{ $row->id }}" @if($row->route == $c->route) active @else hidden @endif>{{ $row->bidang }}</option>
