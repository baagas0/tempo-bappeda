...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <div class="card">
            <form method="POST" action="{{ (empty($data) ? route('link.store') : route('link.update', $data->id)) }}">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="title" class="control-label col-form-label">Nama Tautan</label>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="link_order" class="control-label col-form-label">Urutan</label>
                                <input type="text" required class="form-control" id="url" name="link_order" value="{{ (empty($data) ? old('url') : $data->link_order) }}">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
