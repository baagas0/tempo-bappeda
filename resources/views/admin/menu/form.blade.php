                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jenurl">
                                    ...
                                    <option value="1" {{ empty($data) ? (old('jenurl') == '1' ? 'selected' : '') : ($data->jenurl == '1' ? 'selected' : '') }}>Sub</option>

                                    <option value="2" {{ empty($data) ? (old('jenurl') == '2' ? 'selected' : '') : ($data->jenurl == '2' ? 'selected' : '') }}>Main</option> 
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
