...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <div class="card">
            <form method="POST" action="{{ (empty($data) ? route('run-text.store') : route('run-text.update', $data->id)) }}">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" value="{{ (empty($data) ? old('running_text') : $data->running_text) }}" name="running_text">
                            </div>
                        </div>
                    </div>
                </div>
