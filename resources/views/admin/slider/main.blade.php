    ...
    <table id="PageTable" class="table display">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <img src="{{ asset($data->gambar) }}" alt="Slider" class="" width="80">
                </td>
                <td>
                    {!! ($data->flag == '1') ? '<span class="badge badge-pill badge-success float-right">Tampil</span>' : '<span class="badge badge-pill badge-danger float-right">Tidak</span>' !!}
                </td>
                <td>
                    <div class="btn-group">
