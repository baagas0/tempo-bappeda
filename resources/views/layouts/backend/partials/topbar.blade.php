<div class="header-section">
    ...
    <div class="logo">
        <a href="index.html">
            <span class="logo-img">
                <img src="https://bappeda.semarangkota.go.id/packages/tugumuda/claravel/assets/images/favicon.png" alt="" height="26">
            </span>
            <!--<i class="fa fa-maxcdn"></i>-->
            <span class="brand-name">BAPPEDA</span>
        </a>
    </div>
    ...
    <div class="notification-wrap">
                ...
                <ul class="dropdown-menu mailbox dropdown-menu-right">
                    ...
                    <li class="notification-scroll">
                        <div class="message-center">
                            <a href="#">
                                <div class="user-img">
                                 <img src="{{ asset('backend/assets/images/users/avatar-2.jpg') }}" alt="user" class="rounded-circle"> 
                        ...
                        <a href="#">
                            <div class="user-img">
                                <img src="{{ asset('backend/assets/images/users/avatar-3.jpg') }}" alt="user" class="rounded-circle"> 
                        ...
                        <a href="#">
                            <div class="user-img">
                                <img src="{{ asset('backend/assets/images/users/avatar-4.jpg') }}" alt="user" class="rounded-circle"> 
                        ...
                        <a href="#">
                            <div class="user-img"> 
                                <img src="{{ asset('backend/assets/images/users/avatar-5.jpg') }}" alt="user" class="rounded-circle"> 
        ...
        <li>
            ...
            <div class="dropdown-menu dropdown-menu-right profile-menu">
                ...
                <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();"><i class="mdi mdi-logout m-r-5 text-muted"></i> Logout</a>
