		...
		<div class="">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					...
					text-align: center;
					color: white;">
						<img src="{{ asset('frontend/images/bg.jpg') }}" class="img-reponsive" style="object-fit: cover;
						width: 100%;
						height: 180px;">
						<h2 style="position: absolute;
						top: 75%;
						left: 50%;
						transform: translate(-50%, -50%);color: #ffffff;text-decoration: underline;">Berita</h2>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-9 col-md-12 col-sm-12 col-12">
					...
					<div class="blog_post_style2 blog_single_div" >
						<div class="blog_post_style2_img wow fadeInUp">
							...
							<video controls style="object-fit: cover;
								...
								@else 
								<a href="{{ route('..blog',$ig->id) }}" style="width: 100%">
								<img style="object-fit: cover;
								width: 100%;
								height: 250px;" src="{{ asset($d) }}" alt="" class="img-reponsive">
								</a>
								@endif
							@endforeach
						</div>

						<a href="{{ route('..blog',$ig->id) }}">
						<div class="blog_post_style2_content wow fadeInUp" style="margin-top: -20px;background-color: #f5f4f9!important; border-radius: 0px 0px 10px 10px;-webkit-box-shadow: 0px 10px 20px -10px rgba(0,0,0,0.75);
						-moz-box-shadow: 0px 10px 20px -10px rgba(0,0,0,0.75);
						box-shadow: 0px 10px 20px -10px rgba(0,0,0,0.75);">
							<h3>{!! Str::limit($ig->caption, 25) !!}</h3>
							
							{!! Str::limit($ig->caption, 450) !!}
							<ul class="blog_meta_tags">
								<li><span class="" style="background-color: red"><svg xmlns="http://www.w3.org/2000/svg" width="12px" height="7px"><path fill-rule="evenodd"  fill="rgb(255, 255, 255)" d="M11.829,3.074 C11.732,2.948 9.422,-0.000 6.468,-0.000 C3.514,-0.000 1.203,2.948 1.106,3.074 C0.916,3.320 0.916,3.678 1.106,3.925 C1.203,4.050 3.514,6.999 6.468,6.999 C9.422,6.999 11.732,4.050 11.829,3.925 C12.020,3.678 12.020,3.320 11.829,3.074 ZM7.370,1.771 C7.569,1.651 7.846,1.788 7.989,2.077 C8.132,2.366 8.087,2.696 7.888,2.816 C7.689,2.936 7.412,2.799 7.269,2.510 C7.126,2.221 7.171,1.890 7.370,1.771 ZM6.468,5.930 C4.404,5.930 2.668,4.183 2.067,3.499 C2.473,3.037 3.397,2.091 4.589,1.525 C4.357,1.915 4.220,2.381 4.220,2.883 C4.220,4.251 5.227,5.360 6.468,5.360 C7.709,5.360 8.715,4.251 8.715,2.883 C8.715,2.381 8.579,1.915 8.346,1.525 C9.539,2.091 10.463,3.037 10.869,3.499 C10.268,4.184 8.531,5.930 6.468,5.930 Z"/></svg> Read More</span></li> 
					...
					{{ $igs->links('vendor.pagination.default') }}
				</div>
