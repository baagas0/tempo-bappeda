...
<head>
    <title>{{ env('APP_NAME', 'BAPPEDA').' - '.Str::limit($ig->caption, 10) }}</title>
    <meta charset="utf-8">
				...
				<div class="col-lg-9 col-md-12 col-sm-12 col-12">
					<div class="blog_post_style2 blog_single_div">
						<div class="blog_post_style2_img wow fadeInUp">
	                        ...
	                        @else 
	                            <img src="{{ asset($d) }}" alt="" class="img-fluid">
	                        @endif
	                    @endforeach
						</div>
						<div class="blog_post_style2_content wow fadeInUp" style="">
							<h3>{{ Str::limit($ig->caption, 30) }}</h3>
					...
					<div class="blog_comment_div">
						<h3 class="wow fadeInUp">Komentar <span>(1)</span></h3>
									...
									<li>
										<div class="blog_comment">
											...
											<div class="blog_comment_data">
												<h3>{{ $c->name }} <span>- {{ date('d M Y', strtotime($c->created_at)) }}</span></h3>
												<p>{{ $c->comment }}</p>
											</div>
										</div>
									</li>
					...
					<div class="blog_comment_formdiv wow fadeInUp">
						...
						<form class="comment-form" action="blog/18/commentas/{{ $ig->id }}" method="POST">
							@csrf
							<div class="blog_row">
							...
							<div class="blog_row">
								<button type="submit" class="blog_btn blog_bg_pink">Kirim Komentar</button>
							</div>
						</form>
					</div>
				</div>
