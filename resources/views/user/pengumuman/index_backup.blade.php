			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					...
					color: white;">
						...
						top: 75%;
						left: 50%;
						transform: translate(-50%, -50%);color: #ffffff;text-decoration: underline;">Pengumuman</h2>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-9 col-md-12 col-sm-12 col-12">
					...
					<div class="blog_post_style2 blog_single_div" >
						<div class="blog_post_style2_img wow fadeInUp">
							...
							<a href="{{ route('..pengumuman',$announcement->id) }}" style="width: 100%">
								<img style="object-fit: cover;
								width: 100%;
								height: 250px;" src="{{ asset($announcement->file) }}" alt="" class="img-reponsive">
							</a>
						</div>

						<a href="{{ route('..pengumuman',$announcement->id) }}">
						<div class="blog_post_style2_content wow fadeInUp" style="background-color: #f5f4f9!important; border-radius: 0px 0px 10px 10px;-webkit-box-shadow: 0px 10px 20px -10px rgba(0,0,0,0.75);
						-moz-box-shadow: 0px 10px 20px -10px rgba(0,0,0,0.75);
						box-shadow: 0px 10px 20px -10px rgba(0,0,0,0.75);">
							<h3>{{ $announcement->title }}</h3>
							
							{!! Str::limit($announcement->content, 450) !!}
							<ul class="blog_meta_tags">
