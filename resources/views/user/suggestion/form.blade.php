...
<body>
    ...
    <div id="form_container">
        <div class="row no-gutters">
            <div class="col-lg-4">
                <div id="left_form" style="background-color:#FE4E4E!important">
                    ...
                    <p>Ini merupakan platform pesan & saran digital resmi milik BAPPEDA Kota SEMARANG</p>
                    <a href="#" class="btn_1 rounded blue purchase" target="_parent">{{ $bidang->bidang }}</a>
            ...
            <div class="col-lg-8">
                <div id="wizard_container">
                    ...
                    <!-- /top-wizard -->
                    <form id="wrapped" method="post" action="{{ route('..add.suggestion', $suggestion->id) }}">
						@csrf
                        ...
                        <div id="middle-wizard">
                            ...
                            <div class="step">
								...
								<div class="row" style="padding-bottom:15px">
									<div class="col-md-12">
										<h3 class="main_question"><i class="arrow_right"></i>Pesan & Saran*</h3>
										<textarea name="suggestion" id="suggestion" class="form-control required" onchange="getVals(this, 'suggestion');"></textarea> 
									</div>
								</div>
                            </div>
                            <!-- /step-->
